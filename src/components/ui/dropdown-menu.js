...
const DropdownMenuItem = React.forwardRef(function DropdownMenuItem(
  ...
  return (
    <DropdownMenuPrimitive.Item
      ref={ref}
      className={cn("relative flex cursor-default select-none items-center gap-2", inset && "pl-8", className)}
      {...props}
    />
  );
});
...
const DropdownMenuCheckboxItem = React.forwardRef(function DropdownMenuCheckboxItem(
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ref={ref}
      className={cn("relative flex cursor-default select-none items-center rounded-sm", className)}
      checked={checked}
      {...props}
    >
